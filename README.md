...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/recordlinkage-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11316&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/recordlinkage-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `recordlinkage` can be installed with:

```
conda install recordlinkage
```

It is possible to list all of the versions of `recordlinkage` available on your platform with:
